...
![Chọn Metric](/fcaj-learning-workshop/images/5-Workshop/5.6-Operations-Security/5.6.3-Monitoring-Alarms/select-metric.png)
...
![Cấu hình Alarm](/fcaj-learning-workshop/images/5-Workshop/5.6-Operations-Security/5.6.3-Monitoring-Alarms/alarm-config.png)

6. Cấu hình hành động — Tạo hoặc chọn **SNS topic** để gửi email thông báo:

![Cấu hình SNS](/fcaj-learning-workshop/images/5-Workshop/5.6-Operations-Security/5.6.3-Monitoring-Alarms/sns-config.png)

7. Đặt tên alarm: `jobs-matching-evaluate-match-errors`

8. Click **Create alarm**

![Alarm đã tạo](/fcaj-learning-workshop/images/5-Workshop/5.6-Operations-Security/5.6.3-Monitoring-Alarms/alarm-created.png)
