...
Create the Lambda Function using Python.

The Lambda receives JSON data from the Process Job stage.
...
* Normalize location.
* Generate identifier key (ID) if necessary.
* Remove invalid data.
...
After the data is normalized, write the record to the Jobs table.
