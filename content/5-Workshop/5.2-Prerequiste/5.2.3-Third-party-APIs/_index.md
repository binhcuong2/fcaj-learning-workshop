...
In this section, we will obtain the necessary API keys from third-party services to integrate external search and AI capabilities into our project.

---

### 1. Get API Key from SerpAPI

SerpAPI is used to query search engine results programmatically.
...
The Gemini API is used to integrate generative AI features.
